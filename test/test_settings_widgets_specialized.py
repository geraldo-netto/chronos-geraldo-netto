...
class WeatherLocationSuggestionTest(unittest.TestCase):
    ...
    def test_local_city_name_uses_the_shared_timezone_extraction_cases(self):
        # Named identifiers share extraction cases with runtime weather queries.
        # The runtime additionally resolves symbolic local through native GLib;
        # this Python helper receives an already-resolved identifier instead.
        fixture = json.loads(
...
class TimezoneDataStandsAloneTest(unittest.TestCase):
    ...
    def test_a_zone_in_the_wrong_case_is_not_a_zone_with_no_python_tzdata(self):
        """T814: with neither Python timezone index supplying data,
        looks_like_iana was the only check a typed zone got, and it
