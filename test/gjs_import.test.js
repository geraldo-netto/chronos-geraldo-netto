                ...
                applets: {
                    "chronos@geraldo-netto": {
                        ...
                        holidayRecord: {
                            ...
                            validHolidaySpan() {},
                            holidaySpanDays() {},
                            clampHolidayName(name) { return name; },
                            compareCodeUnits() { return 0; },
                            mergeHolidayFlags() { return []; },
                            withHolidayFlag() { return []; },
                            joinHolidayEntry() { return {}; },
                            sameHolidayFlags() { return true; },
                            MAX_HOLIDAY_NAME_LENGTH: 300,
...
const EXPORTS = {
    ...
    dateMath: ["MSECS_IN_DAY", "monthWindowStartOffset", "dtEquals", "localDateParts",
        "civilDayNumber", "addCivilDays", "civilWeekday", "sameCivilDate", "civilDateKey",
        "monthWindowStart"],
    ...
    weatherServiceAdapters: ["GEOCODE_CANDIDATE_COUNT",
        ...
        "forecastUrl", "metNoForecastUrl", "aviationWeatherUrls", "aviationWeatherIcon",
    ...
    holidayRecord: ["validDateParts", "validHolidaySpan", "holidaySpanDays",
        ...
        "MAX_HOLIDAY_NAME_LENGTH", "clampHolidayName", "compareCodeUnits",
        "mergeHolidayFlags", "withHolidayFlag", "joinHolidayEntry",
        "sameHolidayFlags", "HolidayRecordContract"],
    ...
    worldclockData: ["MAX_CLOCKS", "MAX_CLOCK_LABEL_CELLS", "MAX_CLOCK_INPUT_LABEL_LENGTH",
        ...
        "timezoneIdentity", "timezoneWeatherRequest", "regionalTimezoneIdentifier",
        "localTimezoneFromSources",
    ...
    menuLayout: ["MENU_LAYOUT_HORIZONTAL", "MENU_LAYOUT_STACKED",
        "MENU_WORK_AREA_WIDTH_FRACTION", "MENU_WORK_AREA_HEIGHT_FRACTION",
