...
rootModules.eventMutationStream = require(path.join(APPLET_DIR, "eventMutationStream.js"));
rootModules.eventFetchCoordinator = require(path.join(APPLET_DIR, "eventFetchCoordinator.js"));
...
rootModules.astronomyDay = require(path.join(APPLET_DIR, "astronomyDay.js"));
