...
function createPanelPort(applet) {
    return {
        ...
        cityWeatherReading: (timezone) => applet._weatherCoordinator.cityReading(timezone),
        cityWeatherStale: (timezone) => applet._weatherCoordinator.cityStale(timezone),
        cityWeatherError: (timezone) => applet._weatherCoordinator.cityError(timezone),
        cityWeatherProviderName: (timezone) => applet._weatherCoordinator.cityProviderName(timezone),
